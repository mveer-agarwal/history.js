...
(function(factory) {
    ...
    // Store state against current URl
    var historyMap = {};
    ...
    function firePopState(currentUrl) {
        ...
        } else if(currentUrl && historyObject.state) {
     ...
     */
    function fireInitialState(currentURL) {
        if (isFireInitialState) {
            isFireInitialState = false;
            firePopState(currentURL);
        }
    }
